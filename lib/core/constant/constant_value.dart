...
const String passwordFailure = "Password is incorrect";

const String emailAlreadyExist = "Email is already exist!";

const String tokenLocal = "token";

class SvgIcon {
  static String starYellow = "assets/images/icon/star_yellow.svg";
